 ...
 *
 * All the commands exposed by the client have the same signature as described
 * by the Redis documentation, but some of them offer an additional and more
 * friendly interface to ease programming which is described in the following
 * list of methods:
 *
